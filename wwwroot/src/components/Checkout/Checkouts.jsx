    ...
    <div className="container mb-80 mt-50">
        ...
        <div className="col-lg-5">
            ...
            <div className="table-responsive order_table checkout">
                ...
                <tbody>
                    <tr>
                    <td className="image product-thumbnail"><img src="/src/assets/imgs/shop/product-1-1.jpg" alt="#" /></td>
                    <td>
                    ...
                    <tr>
                    <td className="image product-thumbnail"><img src="/src/assets/imgs/shop/product-2-1.jpg" alt="#" /></td>
                    <td>
                    ...
                    <tr>
                    <td className="image product-thumbnail"><img src="/src/assets/imgs/shop/product-3-1.jpg" alt="#" /></td>
                    <td>
            ...
            <div className="payment-logo d-flex">
                <img className="mr-15" src="/src/assets/imgs/theme/icons/payment-paypal.svg" alt />
                <img className="mr-15" src="/src/assets/imgs/theme/icons/payment-visa.svg" alt />
                <img className="mr-15" src="/src/assets/imgs/theme/icons/payment-master.svg" alt />
                <img src="/src/assets/imgs/theme/icons/payment-zapper.svg" alt />
            </div>
